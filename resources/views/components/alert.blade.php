...
@php
    ...
    $colors = $colors[$type] ?? $colors['info'];
@endphp

<div class="{{ $colors['bg'] }} {{ $colors['border'] }} border rounded-lg p-4" role="alert">
    <div class="flex">
        ...
        @if($dismissible)
            <button type="button" class="ml-auto pl-3 -mx-1.5 -my-1.5 {{ $colors['text'] }} hover:opacity-75 focus:outline-none" onclick="this.parentElement.style.display='none';">
